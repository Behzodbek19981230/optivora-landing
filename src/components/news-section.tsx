        ...
        <section id="news" className="py-24 bg-background">
            ...
            {t("projectsIntro")}
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {news.slice(0, 3).map((newItem: News, index: number) => (
                        <Card
                        ...
                        >
                            ...
                            <CardHeader>
                                ...
                                <div className="flex flex-wrap items-center gap-2 text-xs text-muted-foreground mb-2">
                                    ...
                                    <span>{moment(newItem.published_at).format('DD.MM.YYYY')}</span>
                                </div>
                ...
                <div className="text-center mt-12">
                    <Button
                        size="lg"
                        className="hero-shadow smooth-transition hover:scale-105"
                        onClick={() => router.push(`/${lang}/news` as unknown as any)}
                    >
                        {t('allNews')}
