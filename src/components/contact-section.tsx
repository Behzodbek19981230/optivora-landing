                    ...
                    <div className="grid md:grid-cols-2 gap-12">
                        ...
                        <div className="bg-card rounded-2xl p-8">
                            {sended ? <Card className="card-shadow">
                                ...
                                <div>
                                    <Input placeholder={t('contactFormFullNamePlaceholder') || 'Full name'} className="bg-background" onChange={(e) => setFormData({ ...formData, full_name: e.target.value })} />
                                </div>
                                <div>
                                    <Input type="email" placeholder={t('contactFormEmailPlaceholder') || 'Email address'} className="bg-background" onChange={(e) => setFormData({ ...formData, email: e.target.value })} />
                                </div>
                                <div>
                                    <Input placeholder={t('contactFormCompanyPlaceholder') || 'Company'} className="bg-background" onChange={(e) => setFormData({ ...formData, company: e.target.value })} />
                                </div>
                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        <SelectContent>
                                            <SelectItem value="equipment">{t('contactFormInquiryEquipment') || 'Equipment Supply Inquiry'}</SelectItem>
                                            <SelectItem value="technical">{t('contactFormInquiryTechnical') || 'Technical Consultation'}</SelectItem>
                                            <SelectItem value="quotation">{t('contactFormInquiryQuotation') || 'Project Quotation Request'}</SelectItem>
                                            <SelectItem value="partnership">{t('contactFormInquiryPartnership') || 'Partnership Opportunity'}</SelectItem>
                                            <SelectItem value="general">{t('contactFormInquiryGeneral') || 'General Question'}</SelectItem>
                                        </SelectContent>
                                    </Select>
                                </div>
                                <div>
                                    ...
                                    >
                                        ...
                                        <SelectContent>
                                            <SelectItem value="power_generation">{t('contactFormSectorPower') || 'Power Generation'}</SelectItem>
                                            <SelectItem value="water_wastewater">{t('contactFormSectorWater') || 'Water & Wastewater'}</SelectItem>
                                            <SelectItem value="oil_gas">{t('contactFormSectorOil') || 'Oil & Gas'}</SelectItem>
                                            <SelectItem value="industrial_manufacturing">{t('contactFormSectorIndustry') || 'Industrial Manufacturing'}</SelectItem>
                                            <SelectItem value="renewable_energy">{t('contactFormSectorRenewable') || 'Renewable Energy'}</SelectItem>
                                            <SelectItem value="other">{t('contactFormSectorOther') || 'Other'}</SelectItem>
                                        </SelectContent>
                                    </Select>
